 ...
 * @haoxz11MyBatis
 */
public class SysUserDTO extends LogBaseVo {
	 ...
	 * 字段：登录名
	 */
	@ValidationParam(type = ValidationType.NotBlank, msg = "登录名不能为空")
	private String logonName;

	/**
	 * 字段：登录密码
	 */
	@ValidationParam(type = ValidationType.NotBlank, msg = "密码不能为空")
	 ...
	 * @haoxz11MyBatis
	 */
	@ValidationParam(type = ValidationType.NotBlank, msg = "显示名不能为空")
	 ...
	 * 用户角色
	 */
    List<SysUserRoleDTO> sysUserRoleList;
    
    /**
	 * 用户机构
	 */
    List<SysUserOrgDTO> sysUserOrgList;

	List<SysOrgDepartment> sysOrgDepartmentList;

	public List<SysOrgDepartment> getSysOrgDepartmentList() {
		return sysOrgDepartmentList;
	}

	public void setSysOrgDepartmentList(List<SysOrgDepartment> sysOrgDepartmentList) {
		this.sysOrgDepartmentList = sysOrgDepartmentList;
	}

	public List<SysUserRoleDTO> getSysUserRoleList() {
		return sysUserRoleList;
	}

	public void setSysUserRoleList(List<SysUserRoleDTO> sysUserRoleList) {
		this.sysUserRoleList = sysUserRoleList;
	}

	
	public List<SysUserOrgDTO> getSysUserOrgList() {
		return sysUserOrgList;
	}

	public void setSysUserOrgList(List<SysUserOrgDTO> sysUserOrgList) {
		this.sysUserOrgList = sysUserOrgList;
	}
	...
	public SysUserDTO(String logonName, String displayName) {
		super();
