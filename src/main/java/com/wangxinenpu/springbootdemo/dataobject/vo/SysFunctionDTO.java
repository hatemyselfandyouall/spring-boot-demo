 ...
 * @haoxz11MyBatis
 */
public class SysFunctionDTO extends BaseVo {
	/**
	 *
	 * @haoxz11MyBatis
	 */
	...
	/**
	 * 字段：功能分类,0通用1系统功能2业务功能3事项功能（扩展：个人、单位、机构）
	 *
	 * @haoxz11MyBatis
	 */
	...
	/**
	 * 系统类型 1：管理系统  2： 统征经办系统 3：统征工伤系统 4：统征网报系统 
	 */
	private String systemType;



	private List<SystemIconDTO> iconList;
	...
	private SysFunctionSetPermissionForOrgsVO sysFunctionSetPermissionForOrgsVO;
	...
	public List<SystemIconDTO> getIconList() {
		return iconList;
	}

	public void setIconList(List<SystemIconDTO> iconList) {
	...
	public SysFunctionSetPermissionForOrgsVO getSysFunctionSetPermissionForOrgsVO() {
		return sysFunctionSetPermissionForOrgsVO;
	}

	public void setSysFunctionSetPermissionForOrgsVO(SysFunctionSetPermissionForOrgsVO sysFunctionSetPermissionForOrgsVO) {
		this.sysFunctionSetPermissionForOrgsVO = sysFunctionSetPermissionForOrgsVO;
	}
